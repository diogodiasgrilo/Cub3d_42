...
/*   Updated: 2023/06/12 15:25:14 by diogpere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	...
	{
		my_mlx_pixel_put(&g->scene,(ray * SCALE), sc.y + floor(HALF_HEIGHT - sc.proj_height / 2), NEWWHITE);
		my_mlx_pixel_put(&g->scene,(ray * SCALE) + 1, sc.y + floor(HALF_HEIGHT - sc.proj_height / 2), NEWWHITE);
	}
}